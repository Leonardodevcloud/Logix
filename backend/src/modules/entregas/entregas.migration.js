...
async function migrarColunasExtras() {
  const cols = [
    ...
    "ALTER TABLE entregas_pontos ADD COLUMN IF NOT EXISTS liberado BOOLEAN NOT NULL DEFAULT FALSE",
    "ALTER TABLE entregas_pontos ADD COLUMN IF NOT EXISTS liberacao_solicitada_em TIMESTAMPTZ",
    "ALTER TABLE entregas_pontos ADD COLUMN IF NOT EXISTS liberacao_motivo TEXT",
    "ALTER TABLE entregas_pontos ADD COLUMN IF NOT EXISTS liberado_por UUID",
    "ALTER TABLE entregas_pontos ADD COLUMN IF NOT EXISTS liberado_em TIMESTAMPTZ",
    ...
    "ALTER TABLE entregas ADD COLUMN IF NOT EXISTS preco_dinamico_id UUID",
    "ALTER TABLE entregas ADD COLUMN IF NOT EXISTS dinamica_add_cliente_cent INTEGER NOT NULL DEFAULT 0",
    "ALTER TABLE entregas ADD COLUMN IF NOT EXISTS dinamica_add_motoboy_cent INTEGER NOT NULL DEFAULT 0",
  ];
